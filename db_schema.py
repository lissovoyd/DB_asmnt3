...
class Patients(db.Model):
    ...
    __table_args__ = {'schema': 'asmnt3'}
    email = db.Column(db.String(60), db.ForeignKey('asmnt3.user.email'), primary_key=True)
...
class Specialize(db.Model):
    ...
    __table_args__ = {'schema': 'asmnt3'}
    id = db.Column(db.Integer, db.ForeignKey('asmnt3.diseasetype.id'), primary_key=True)
...
class Record(db.Model):
    ...
    __table_args__ = {'schema': 'asmnt3'}
    email = db.Column(db.String(60), db.ForeignKey('asmnt3.publicservant.email'), primary_key=True)
    cname = db.Column(db.String(50), db.ForeignKey('asmnt3.country.cname'), primary_key=True)
    disease_code = db.Column(db.String(50), db.ForeignKey('asmnt3.disease.disease_code'), primary_key=True)
